...
final case class Envelope private (val message: Any, val sender: ActorRef) {
  // DOTTY -> bug copy method becomes private with private constructor
...
abstract class MessageDispatcher(val configurator: MessageDispatcherConfigurator)
  ...
  // DOTTY -> private this got erased
  @silent @volatile private var _inhabitantsDoNotCallMeDirectly: Long = _ // DO NOT TOUCH!
  @silent @volatile private var _shutdownScheduleDoNotCallMeDirectly: Int = _ // DO NOT TOUCH!
