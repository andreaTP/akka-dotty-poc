...
object SimpleDnsCache {
  ...
  // DOTTY
  // this looks like an edge case in Scala compiler
  // non-private constructor Cache refers to private class CacheEntry
  protected case class CacheEntry[T](answer: T, until: Long) {
